...
*Ω* = {(*P*, *P*),(*P*, *R*, *Q*, *P*, *P*),(*P*, *R*, *Q*, *P*, *R*, *Q*, *P*, *P*),...}
...
**Ejercicio 5** Un trabajador produce n partes de un artículo. Sea *A*<sub>*i*</sub> el evento ‘la i-ésima parte está defectuosa’. Exprese en términos de los *A*<sub>*i*</sub> cada uno de los siguientes eventos:

    a) ninguna de las n partes está defectuosa,

$$\\bigcap\_{i=1}^n A\_i^c $$
